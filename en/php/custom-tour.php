    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title">MAKE YOUR OWN TRIP</h4>
            </div>
            <div class="modal-body">
                <h5 class="services-sm-title text-muted">We offer you the opportunity to show your creativity and come
                    up with your own trip for you and your friends and have an amazing time!</h5>

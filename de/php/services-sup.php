...
<div id="services-sup" class="modal fade" role="dialog" aria-labelledby="myModalLabel">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content" >
            ...
            <p class="text-muted">
             Obwohl es meist für eine neue Sportart gehalten wird, stellt das Stehpaddeln (auch Stand UpPaddling bzw. SUP genannt) tatsächlich die früheste Form des Wellenreitens dar, die auf polynesische Fischer zurückgeht. Vor zehn Jahren wurde diese alte Sportart auf Hawaii erfolgreich wiederbelebt, und hat sich von dem ursprünglichen Wellenreiten über Freizeitpaddeln auf dem Brett, SUP Yoga und Reggatten bis zu Wildwasserpaddeln weiterentwickelt. Wir stellen mehrere Freizeitbretter zur Verfügung, die es ermöglichen per Stehpaddel unsere wunderbaren Gewässer zu erkunden.
            </p>
  ...
  <div class="panel-body">
    ...
    <div id="links">
        <div class="imgwrapper botmargin card-2">
            ...
            <img src="../img/sup/s1.jpg" data-src="../img/sup/s1.jpg"" class="img img-responsive img-rounded " alt="windsurf"></a>
        </div>
        <div class="imgwrapper botmargin card-2">
             <a href="../img/sup/s2.jpg"" title="windsurfing">
            <img src="../img/sup/s2.jpg"" data-src="../img/sup/s2.jpg"" class="img img-responsive img-rounded " alt="windsurf"></a>
        </div>
        <div class="imgwrapper botmargin card-2">
